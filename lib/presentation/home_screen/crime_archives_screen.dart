...
class CrimeArchivesScreen extends StatefulWidget {
  final List<Podcast> podcasts;
  const CrimeArchivesScreen({Key? key, required this.podcasts})
      : super(key: key);

  @override
  State<CrimeArchivesScreen> createState() => _CrimeArchivesScreenState();
}

class _CrimeArchivesScreenState extends State<CrimeArchivesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Crime Archives'),
        leading: IconButton(
